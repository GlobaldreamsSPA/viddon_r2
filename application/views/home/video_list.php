				...
				<div class="row-fluid">
					...
					<div class="pagination">  
					  <ul id="pagination_bt">
					    ...
					    <li <?php if($page==1) echo "class='disabled'";?> ><a <?if($page!=1) echo "href= '".base_url()."home/video_list/".($page-1)."/".$actual_skills_url."'";?>>Prev</a></li>  
						<?php for($i = 1; $i <= $chunks; $i++) { ?>
							<li <?php if($page==$i) echo "class='disabled'";?> ><a <?if($page!=$i) echo "href= '".base_url()."home/video_list/".$i."/".$actual_skills_url."'";?> > <?php echo $i; ?></a></li>  
						<?php } ?>
					    <li <?php if($page==$chunks) echo "class='disabled'";?> ><a <?if($page!=$chunks) echo "href= '".base_url()."home/video_list/".($page+1)."/".$actual_skills_url."'";?>>Next</a></li>
